...
const TILES = [
  { href: '/assignments', label: 'Assignments', desc: 'Create + grade assessments', Icon: BookOpen },
  { href: '/assignments/new', label: 'Create Assignment', desc: 'AI-generated question paper', Icon: Sparkles },
  { href: '/library', label: 'My Library', desc: 'Saved papers and rubrics', Icon: FileText },
  { href: '/groups', label: 'My Groups', desc: 'Class rosters', Icon: Users },
];
...
export default function HomePage() {
  return (
    <div className="px-4 lg:px-0">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-ink">Welcome back, John 👋</h1>
