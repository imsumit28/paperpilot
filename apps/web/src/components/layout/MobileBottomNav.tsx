...
function HomeIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="currentColor" aria-hidden>
      <path d="M0 2.71698C0 1.21643 1.21643 0 2.71698 0H5.77359C7.27413 0 8.49057 1.21643 8.49057 2.71698V5.77359C8.49057 7.27413 7.27413 8.49057 5.77358 8.49057H2.71698C1.21643 8.49057 0 7.27413 0 5.77358V2.71698Z" />
      <path d="M9.50928 2.71698C9.50928 1.21643 10.7257 0 12.2263 0H15.2829C16.7834 0 17.9998 1.21643 17.9998 2.71698V5.77359C17.9998 7.27413 16.7834 8.49057 15.2829 8.49057H12.2263C10.7257 8.49057 9.50928 7.27413 9.50928 5.77358V2.71698Z" />
      <path d="M0 12.2265C0 10.726 1.21643 9.50952 2.71698 9.50952H5.77359C7.27413 9.50952 8.49057 10.726 8.49057 12.2265V15.2831C8.49057 16.7837 7.27413 18.0001 5.77358 18.0001H2.71698C1.21643 18.0001 0 16.7837 0 15.2831V12.2265Z" />
      <path d="M9.50928 12.2265C9.50928 10.726 10.7257 9.50952 12.2263 9.50952H15.2829C16.7834 9.50952 17.9998 10.726 17.9998 12.2265V15.2831C17.9998 16.7837 16.7834 18.0001 15.2829 18.0001H12.2263C10.7257 18.0001 9.50928 16.7837 9.50928 15.2831V12.2265Z" />
    </svg>
  );
}
...
export function MobileBottomNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-4 left-1/2 -translate-x-1/2 z-30 w-[373px] max-w-[calc(100vw-20px)]">
      <div className="bottom-nav-shadow bg-ink rounded-[24px] h-[72px] flex items-center justify-between px-6 gap-[43px]">
        {ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? 'text-brand-300' : 'text-white/55 hover:text-white/80',
              )}
            >
              ...
              <span className="text-[12px] font-semibold leading-[1.4] tracking-[-0.02em] whitespace-nowrap">
                {item.label}
              </span>
            </Link>
          );
